...
## Works Cited
 ...
 3. Lornatang/SRGAN-PyTorch: A simple and complete implementation of
    super-resolution paper. - GitHub, accessed on 11 July 2025,
    <https://github.com/Lornatang/SRGAN-PyTorch>

 4. hep-lbdl/SRGN - GitHub, accessed on 11 July 2025,
    <https://github.com/hep-lbdl/SRGN>

 5. Security - hep-lbdl/SRGN - GitHub, accessed on 11 July 2025,
 ...
 6. How to Open and Manage Leveraged $SRGN (SolRagon) Trades on Hyperliquid: A
    ...
    GitHub, accessed on 11 July 2025,
    <https://github.com/synthesizearrayHSy/generatemonitorGhZ/issues/5>

 7. srgn - Rust - [Docs.rs](http://Docs.rs), accessed on 11 July 2025,
    <https://docs.rs/srgn>

 8. Pattern syntax - Semgrep, accessed on 11 July 2025,
    <https://semgrep.dev/docs/writing-rules/pattern-syntax>

 9. Releases · alexpovel/srgn - GitHub, accessed on 11 July 2025,
    <https://github.com/alexpovel/srgn/releases>

 10. Python Scope & the LEGB Rule: Resolving Names in Your Code, accessed on
    11 July 2025, <https://realpython.com/python-scope-legb-rule/>

 11. Scopes - The Rust Reference, accessed on 11 July 2025,
 ...
 12. I can't understand the Rust "scope" definition (Rust Programming Language,
    2nd Ed. Klabnik & Nichols) - Stack Overflow, accessed on 11 July 2025,
    <https://stackoverflow.com/questions/77423163/i-cant-understand-the-rust-scope-definition-rust-programming-language-2nd-e>

 13. betterletter/README.md at main · alexpovel/betterletter
    · GitHub, accessed on 11 July 2025,
 ...
 14. srgn - Rust Package Registry - [Crates.io](http://Crates.io), accessed on
    11 July 2025, <https://crates.io/crates/srgn/>

 15. <https://github.com/alexpovel/srgn/tree/main/src/scoping/langs>
